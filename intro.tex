...
To ensure consistency, we present results on a single engine type in each section or from both to show that the results are valid for both engines. Results in each section are self-contained
and independent. Moreover the variety of experiments and setup show the versatility of our approach. 
