...
to cluster jobs based on their profiles and choose the most optimal cluster configuration. Aroma \cite{lama2012aroma} optimizes resource allocation and cost of jobs. \eat{In
...
and the best values for a specific workload. \eat{iTuned is also a good example of a system that
